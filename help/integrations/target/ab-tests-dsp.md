...
# A/B-tests configureren in Adobe Target voor Advertising DSP-advertenties
...
Neem contact op met uw Adobe-accountteam als u nog meer vragen hebt.
...
Neem contact op met uw Adobe-accountteam om de vereiste plaatsingssleutel op te halen en de installatie te voltooien en om ervoor te zorgen dat elke doorklikURL wordt gevuld met de plaatsingssleutel.
...
1. Implementeer een Audience Manager-imitatiepixel in uw advertentietags en DSP-plaatsingsinstellingen.
   ...
   Voor instructies, zie &quot;[&#x200B; media blootstellingsgegevens van de campagnes van Advertising DSP verzamelen &#x200B;](/help/integrations/audience-manager/media-data-integration/collect.md).&quot;
...
## Stap 3: Een A/B-testactiviteit instellen in [!DNL Target] voor DSP
...
1. [&#x200B; creeer een test A/B &#x200B;](https://experienceleague.adobe.com/docs/target/using/activities/abtest/create/test-create-ab.html?lang=nl-NL):
   ...
   1. Selecteer **[!UICONTROL Traffic Allocation Method]** voor **[!UICONTROL Manual (Default)]** en deel het publiek 50/50.
...
## Stap 4: stel de [!DNL Analytics for Target] Analysis Workspace in [!DNL Analytics]
...
### Problemen met Analytics voor [!DNL Target] -gegevens oplossen
...
* [&#x200B; Overzicht van  [!DNL Analytics for Advertising]](/help/integrations/analytics/overview.md) - introduceert [!DNL Analytics for Advertising], dat u toestaat om klik-door en mening-door plaatsinteractie in uw instanties van Analytics te volgen.

>[!MORELIKETHIS]
>
>* [&#x200B; vorm A/B tests in Adobe Target voor het Onderzoek van Advertising, Sociale, &amp; Commerce advertenties &#x200B;](ab-tests-search.md)
