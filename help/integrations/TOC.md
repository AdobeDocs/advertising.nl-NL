...
+ [!DNL Analytics for Advertising] {#analytics}
   ...
   + Implementatie plannen {#planning}
      + [Vereisten en belangrijkste informatie voor het uitvoeren  [!DNL Analytics for Advertising]](/help/integrations/analytics/prerequisites.md)
      + [(DSP) JavaScript-code voor  [!DNL Analytics for Advertising]](/help/integrations/analytics/javascript.md)
      + [Het gebruiken van de  [!DNL Last Event Service]  bibliotheek van JavaScript met Adobe Experience Platform  [!DNL Web SDK]](/help/integrations/analytics/web-sdk.md)
   ...
   + Uitwisseling van gegevens {#data}
      + [Adobe Advertising-cijfers in Analysis Workspace](/help/integrations/analytics/advertising-metrics-in-analytics.md)
   ...
   + Werken in [!DNL Analytics Marketing Channels] {#mc}
      ...
      + [Gebruikend Adobe Advertising IDs om  [!DNL Marketing Channels]  verwerkingsregels tot stand te brengen](/help/integrations/analytics/marketing-channels/mc-ids.md)
      ...
      + [Waarom de kanaalgegevens tussen Adobe Advertising en  [!DNL Marketing Channels] kunnen variëren](/help/integrations/analytics/marketing-channels/mc-data-variances.md)
   + [Creeer omzettingsmetriek van Adobe Analytics  [!DNL eVars]  en  [!DNL props]](/help/integrations/analytics/conversion-metrics-from-evars.md)
+ Integratie met Adobe Audience Manager {#audience-manager}
   ...
   + DSP-integratie van mediagegevens met Adobe Audience Manager {#media-data-ingestion}
      + [Overzicht van het verzenden van DSP-media-belichtingsgegevens naar Adobe Audience Manager](/help/integrations/audience-manager/media-data-integration/overview.md)
      + [Afbeelding verzamelen en gegevens klikken in DSP-campagnes](/help/integrations/audience-manager/media-data-integration/collect.md)
      + [Gebruiksscenario&#39;s](/help/integrations/audience-manager/media-data-integration/use-cases.md)
   + [Adobe Audience Analytics voor Advertising-klanten](/help/integrations/audience-manager/audience-analytics.md)
+ Integratie met Adobe Target {#target}
   ...
   + [A/B-tests configureren in Adobe Target voor advertenties voor zoeken, sociale media en Commerce](/help/integrations/target/ab-tests-search.md)
...
+ [&#x200B; Videozelfstudies over de integratie van Adobe Advertising &#x200B;](https://experienceleague.adobe.com/docs/advertising-learn/tutorials/overview.html?lang=nl-NL)
