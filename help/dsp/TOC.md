...
+ Campagnebeheer {#campaign-management}
   ...
   + Plaatsen {#placements}
      + [Informatie over plaatsingsbeheer in Advertising DSP](/help/dsp/campaign-management/placements/placement-about.md)
      ...
      + [Biedingsvermenigvuldigers voor plaatsingen beheren](/help/dsp/campaign-management/placements/placement-manage-bid-multipliers.md)
      + [Advertenties aan plaatsen koppelen en eruit verwijderen](/help/dsp/campaign-management/ads/ad-attach-to-placement.md)
      + [Pixels aan advertenties koppelen en eruit verwijderen](/help/dsp/campaign-management/ads/ad-pixel-attach-detach.md)
      + [Advertentieschema&#39;s voor plaatsing bewerken](/help/dsp/campaign-management/placements/placement-edit-ad-schedule.md)
      + [Gedetailleerd rapport voor plaatsing weergeven](/help/dsp/campaign-management/placements/placement-view-report.md)
      + [Het wijzigingslogboek weergeven voor een plaatsing](/help/dsp/campaign-management/placements/placement-change-log.md)
   ...
   + Inzichten over intercampagne {#insights}
      + [Informatie over inzichten](/help/dsp/campaign-management/insights/insights-about.md)
   + Prestatierapporten in de weergaven van het campagnebeheer {#campaign-reports}
      + [Typen prestatierapporten in de weergaven van het campagnebeheer](/help/dsp/campaign-management/reports/campaign-reports-about.md)
      + [Gegevens exporteren vanuit een campagnebeheerweergave](/help/dsp/campaign-management/reports/campaign-export-data.md)
      + [De sites, advertenties, frequentie en inventarisgegevens voor een plaatsing bekijken](/help/dsp/campaign-management/reports/placement-details-view.md)
      + [Het rapport met de plaatsingsprognose weergeven](/help/dsp/campaign-management/reports/placement-forecast.md)
      + [De diagnostische rapporten voor plaatsing weergeven](/help/dsp/campaign-management/reports/placement-diagnostics.md)
      + [Waarschuwingen weergeven](/help/dsp/campaign-management/reports/campaign-alerts.md)
      + [De weergaven van uw campagnegegevens beheren](/help/dsp/campaign-management/reports/campaign-data-views-manage.md)
...
+ Doelgroepen {#audiences}
   ...
   + [Ondersteuning voor het activeren van universele id&#39;s](/help/dsp/audiences/universal-ids.md)
   + Herbruikbaar publiek {#reusable-audiences}
      ...
      + [Syntaxis voor publiekssegmentlogica](/help/dsp/audiences/audience-segment-logic-syntax.md)
   + Segmenten {#segments}
      ...
      + [!UICONTROL CCPA Opt-out-of-Sale] Segmenten {#ccpa-opt-out-of-sale-segments}
         + [Informatie over [!UICONTROL CCPA Opt-out-of-Sale] segmenten en rapporten](/help/dsp/audiences/ccpa-opt-out-about.md)
      ...
      + [Een segment delen of het delen ervan beëindigen](/help/dsp/audiences/segment-share.md)
      + [Pixels voor bijhouden weergeven voor een segment](/help/dsp/audiences/segment-view-pixels.md)
      + [Een segment verwijderen](/help/dsp/audiences/segment-delete.md)
   + Bronnen {#sources}
      + [Informatie over bronnen voor het eerste publiek](/help/dsp/audiences/sources/source-about.md)
      + Workflows per gegevensplatform van klanten {#sources-workflows}
      ...
      + [Bronnen voor gebruikers beheren om publiek met een universele id te activeren](/help/dsp/audiences/sources/source-manage.md)
   + [Handmatig geverifieerde segmenten importeren uit  [!DNL LiveRamp]](/help/dsp/audiences/sources/source-import-liveramp-segments.md)
...
+ Inventaris {#inventory}
   ...
   + [!DNL On Demand] voorraad {#on-demand}
      ...
      + Beschikbare uitgevers met [!DNL On Demand] premiumvoorraad {#publishers}
         + [[!DNL On Demand] premium-voorraaduitgevers in Asia Pacific](/help/dsp/inventory/on-demand-inventory-publishers-apac.md)
         + [[!DNL On Demand] Uitgevers met premiumvoorraad in Australië en Nieuw-Zeeland](/help/dsp/inventory/on-demand-inventory-publishers-anz.md)
         + [[!DNL On Demand] premium-voorraaduitgevers in Europa, het Midden-Oosten en Afrika](/help/dsp/inventory/on-demand-inventory-publishers-emea.md)
         + [[!DNL On Demand] Uitgevers met premiumvoorraad in Noord-Amerika](/help/dsp/inventory/on-demand-inventory-publishers-na.md)
      + [Abonneren en toegang tot  [!DNL On Demand]  premieinventarisovereenkomsten verzoeken](/help/dsp/inventory/on-demand-inventory-subscribe.md)
      + [Herverzoek  [!DNL On Demand]  premieinventarisovereenkomsten](/help/dsp/inventory/on-demand-inventory-rerequest.md)
      + [Bekijk het statuut van uw  [!DNL On Demand]  overeenkomstenverzoeken en abonnementen](/help/dsp/inventory/on-demand-inventory-view-status.md)
   + Privévoorraad {#private-inventory}
      ...
      + Deal IDs {#deal-ids}
         ...
         + Handmatig ingevoerde deal-IDs {#manual}
            + [Handmatig id-details maken](/help/dsp/inventory/deal-id-create.md)
            + [Handmatige id-instellingen](/help/dsp/inventory/deal-id-settings.md)
         + Door programmacode gegarandeerde deals {#programmatic-guaranteed-deal}
            + [Overzicht van gegarandeerde programmatische deals](/help/dsp/inventory/programmatic-guaranteed-about.md)
      ...
      + [Plaatsen en advertenties voor een persoonlijke deal opgeven](/help/dsp/inventory/deal-id-attach-placements.md)
      + [De accounts bewerken met toegang tot een persoonlijke deal](/help/dsp/inventory/deal-id-share.md)
      + [De adverteerders toegang geven tot een persoonlijke deal](/help/dsp/inventory/deal-id-edit-advertisers.md)
      + [veilinginzichten weergeven voor een persoonlijke deal](/help/dsp/inventory/private-deal-auction-insights.md)
      + [Vermeld de plaatsingen en advertenties voor een persoonlijke deal](/help/dsp/inventory/private-deal-view-placements.md)
   ...
   + [!UICONTROL Simple Ad Serving] deals {#sas}
      ...
      + [[!UICONTROL Simple Ad Serving] deal-instellingen bewerken](/help/dsp/inventory/simple-deal-edit.md)
      + [[!UICONTROL Simple Ad Serving] deal-instellingen](/help/dsp/inventory/simple-deal-settings.md)
   + [Een gedetailleerd rapport weergeven voor een deal](/help/dsp/inventory/deal-view-report.md)
   + [Overeenkomstlijsten beheren](/help/dsp/inventory/lists-deals-manage.md)
+ Aangepaste rapporten {#custom-reports}
   ...
   + Doelen rapporteren {#report-destinations}
      + [Over rapportdoelen](/help/dsp/reports/report-destinations/report-destination-about.md)
      + [Een rapportbestemming maken](/help/dsp/reports/report-destinations/report-destination-create.md)
      + [Een rapportbestemming bewerken](/help/dsp/reports/report-destinations/report-destination-edit.md)
      + [Een rapportbestemming verwijderen](/help/dsp/reports/report-destinations/report-destination-delete.md)
      + [Doelinstellingen rapporteren](/help/dsp/reports/report-destinations/report-destination-settings.md)
+ Planner {#planner}
   + [Het gereedschap DSP [!UICONTROL Planner]](/help/dsp/planner/planner-about.md)
   + [Een verbonden tv-bereikplan maken](/help/dsp/planner/planner-create.md)
   + [Een aangesloten tv-bereik dupliceren](/help/dsp/planner/planner-duplicate.md)
   + [Een abonnement voor verbonden tv-bereik bewerken](/help/dsp/planner/planner-edit.md)
   + [Instellingen voor bereikplannen voor verbonden tv](/help/dsp/planner/planner-settings.md)
   + [Een prognose exporteren voor een bereik van verbonden tv](/help/dsp/planner/planner-export.md)
   + [De prognose voor een bereik van verbonden tv opnieuw genereren](/help/dsp/planner/planner-forecast.md)
   + [Een bereik van verbonden tv archiveren](/help/dsp/planner/planner-archive.md)
+ Bronnen {#resources}
