---
title: De sites, advertenties, frequentie en inventarisgegevens voor een plaatsing bekijken
...
# De sites, advertenties, frequentie en inventarisgegevens voor een plaatsing bekijken
...
## Informatie in de plaatsing [!UICONTROL Inspector] {#placement-inspector}
...
## De plaatsing openen [!UICONTROL Inspector] {#inspector-open}
...
## Een advertentie verwijderen uit een plaatsing vanuit de [!UICONTROL Inspector] {#remove-ads-placement-inspector}

1. [ open de plaatsing [!UICONTROL Inspector]](#inspector-open).
...
>* [ beheer uw meningen van campagnegegevens ](campaign-data-views-manage.md)
