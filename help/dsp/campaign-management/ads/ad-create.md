...
Om veelvoudige derdeadvertenties in een tijd tot stand te brengen, zie [ veelvoudige derdeadvertenties ](ad-create-multiple.md) creëren.
...
1. Specificeer de advertentiemontages voor [ audioadvertenties ](ad-settings-audio.md), [ verbonden TV ](ad-settings-connected-tv.md), [ vertoningsadvertenties ](ad-settings-display.md), [ mobiele advertenties ](ad-settings-mobile.md), [ inheemse advertenties ](ad-settings-native.md), [ pre-rol advertenties ](ad-settings-pre-roll.md), of [ universele videoadvertenties ](ad-settings-universal-video.md):
   ...
   1. Voer in het scherm [!UICONTROL Insert Ad Tag] informatie over de advertentie in van een gecertificeerde externe advertentiepartner en klik vervolgens op **[!UICONTROL Go]** .

   1. Op het [!UICONTROL Options] -scherm:

      1. Geef op het tabblad [!UICONTROL Basics] de details van de advertentie op.

      1. (Optioneel) Geef op het tabblad [!UICONTROL Pixel] pixels op die door derden worden bijgehouden en die u aan de advertentie wilt koppelen.
