...
Zie &quot;[&#x200B; wat niet &#x200B;](#campaign-not-duplicated)&quot;voor een lijst van plaatsingsmontages wordt gedupliceerd die niet worden gedupliceerd.
...
## Wat wordt niet gedupliceerd {#campaign-not-duplicated}
...
## Aanbevolen werkwijzen om de nieuwe campagne te configureren
