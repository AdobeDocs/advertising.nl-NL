...
# Gebeurtenisvolgende pixels weergeven voor een [!UICONTROL Simple Ad Serving] -deal

U kunt een exemplaar van gebeurtenis-volgende pixel voor een [!UICONTROL Simple Ad Serving] overeenkomst krijgen om naar uw uitgever voor implementatie te verzenden. De pixel zijn op alle advertenties in de plaatsing van toepassing die door de overeenkomst wordt geproduceerd.
