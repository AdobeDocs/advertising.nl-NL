...
1. Voer in de [!UICONTROL Ad & Deal Tagging] -instellingen een van de volgende handelingen uit:
   ...
   * Om een bestaande markering aan de overeenkomst toe te wijzen, selecteer het controlevakje naast de overeenkomst in de [!UICONTROL Custom Tags] lijst.

   * Als u een tag wilt maken en deze aan de deal wilt koppelen, typt u de tagnaam in het veld **[!UICONTROL Create new tag(s)]** en klikt u op **[!UICONTROL Create and Associate Tag]** .

   * Om een bestaande markering uit de overeenkomst te verwijderen, ontruim de controledoos naast de overeenkomst in de [!UICONTROL Custom Tags] lijst.
