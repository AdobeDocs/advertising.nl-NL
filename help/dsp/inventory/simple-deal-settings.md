---
title: '[!UICONTROL Simple Ad Serving] deal-instellingen'
...
# [!UICONTROL Simple Ad Serving] deal-instellingen
...
| Parameter | Beschrijving |
|-----------|-------------|
| **[!UICONTROL Media CPM]** | De kosten per 1000 afbeeldingen (CPM), zoals weergegeven in de tariefkaart voor uw contract. Neem voor deze waarde contact op met uw Adobe-accountteam. <br><br> specificeer ook de munt voor de overeenkomst. Alle gebruikers kunnen USD selecteren, of, als het SSP extra valuta&#39;s steunt, de munt voor de rekening van DSP. |
| **[!UICONTROL Third Party Billed Fees]** | (Optioneel) Een statische vergoeding voor derden die moet worden bijgehouden als niet-factureerbare kostprijs, en de valuta voor de transactie.<br><br> alle gebruikers kunnen USD selecteren, of, als SSP extra valuta&#39;s steunt, de munt voor de rekening van DSP. **NOTA:** de Billable taksen worden weerspiegeld in [!UICONTROL Net CPM] metrisch. |
