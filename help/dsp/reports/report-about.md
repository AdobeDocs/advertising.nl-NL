...
* Vooraf geconfigureerde rapportsjablonen
   ...
   * **[!UICONTROL All-in Cost BETA]**: (Advertisers met alleen Advertising Creative en Advertising DSP; bètafunctie) Gebruik dit rapport om te zien hoeveel Advertising DSP-uitgaven zijn toegewezen aan advertenties voor Adobe Creative. U kunt creatieve gegevens, kenmerken, doelgegevens en andere gegevens weergeven op campagne-, pakket-, plaatsings- en advertentieniveau.
