...
* Vooraf geconfigureerde rapportsjablonen
   ...
   * **[!UICONTROL All-in Cost]**: (Advertisers met alleen Advertising Creative en Advertising DSP) Gebruik dit rapport om te zien hoeveel Advertising DSP-uitgaven zijn toegewezen aan advertenties voor Adobe Creative. U kunt creatieve gegevens, kenmerken, doelgegevens en andere gegevens weergeven op campagne-, pakket-, plaatsings- en advertentieniveau.
   ...
   * **[!UICONTROL Custom Creative]:** (Alleen adverteerders met Advertising Creative) Gebruik dit rapport om de prestaties in uw Advertising Creative-advertentie te controleren.
   ...
   * **[!UICONTROL Household Conversions]:** gebruik dit rapport om mening-door omzettingen op het niveau van het huishouden te zien die op IP adres, eerder dan op een apparaat/koekjesniveau wordt gebaseerd. Gebruik de inzichten om campagneprestaties te meten en te optimaliseren. Zie &quot;[ FAQs over huisverslagen ](/help/dsp/reports/faq-reports.md)&quot;voor meer informatie. Gegevens zijn niet beschikbaar voor plaatsen die universele id&#39;s als doel hebben.

   * **[!UICONTROL Household Reach & Frequency]:** gebruik dit rapport om beelden, bereik en frequentie voor één enkele afmeting over ad formaten op het niveau van het huishouden te zien die op IP adres, eerder dan op een apparaat/koekjesniveau wordt gebaseerd. Gebruik de inzichten om uw media mengeling te optimaliseren, prestaties te verbeteren, en mogelijkheden voor stijgende bereik te identificeren. Zie &quot;[ FAQs over huisverslagen ](/help/dsp/reports/faq-reports.md)&quot;voor meer informatie. Gegevens zijn niet beschikbaar voor plaatsen die universele id&#39;s als doel hebben.
   ...
   * **[!UICONTROL Path to Conversion]:** gebruik dit rapport om te identificeren hoe u budgetten optimaliseert en advertenties personaliseert op basis van de best presterende en interactiereeksen. Het rapport bevat de reeks interactiepunten in hetzelfde huishouden die leiden tot elk van de geselecteerde conversiemetriek in het opgegeven gegevensbereik. Het rapport gebruikt een gespecificeerde raadplegingsperiode tussen de eerste interactie en een omzetting en kan één dimensie omvatten:
     ...
     Voor een vergelijking van dit rapport aan rapporten die door [!DNL Advanced Measurement Services] en Analytische Adobe worden gecreeerd, zie &quot;[ FAQs over douanerapporten ](/help/dsp/reports/faq-reports.md).&quot;
...
## Rapportage tussen rekeningen {#cross-account-reporting}
...
## De weergave [!UICONTROL Custom Reports]
...
>* [ Veelgestelde vragen over huisrapporten ](/help/dsp/reports/faq-reports.md)
