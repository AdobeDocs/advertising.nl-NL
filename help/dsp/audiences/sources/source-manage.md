---
title: Bronnen voor gebruikers beheren om publiek met een universele id te activeren
...
# Bronnen voor gebruikers beheren om publiek met een universele id te activeren

*eigenschap van Beta*

Maak in DSP een bron voor elk publiek van de eerste partij in het gegevensplatform van uw klant dat u wilt omzetten in segmenten die opgegeven Universal ID-typen bevatten. U kunt de segmenten importeren naar de DSP-account van uw organisatie of naar een adverteerderaccount. Gegevenskosten worden toegepast op basis van de geselecteerde Universal ID-typen. Zodra u een bron creeert, worden de extra stappen vereist om het publiek van elk platform van klantengegevens in te voeren. Zie de nota aan het eind van de procedure om een bron tot stand te brengen.
...
## De id-typen voor een publieksbron wijzigen
...
## Het wijzigingslogboek weergeven voor een publieksbron
