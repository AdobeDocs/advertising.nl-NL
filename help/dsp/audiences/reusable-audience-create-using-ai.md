...
1. Het publiek opbouwen:
   ...
   <!-- When this becomes an open beta, it will be the default for everyone, and the steps will need to be updated accordingly. -->Voor gebruikers met bètamachtigingen is de optie AI de standaardinstelling. Om [ het publiek te assembleren zelf ](/help/dsp/audiences/reusable-audience-create.md), klik de &quot;Schakelaar aan handwijze&quot;knoop bij de bodem.
