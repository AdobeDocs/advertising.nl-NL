...
1. Bewerk de segmentgegevens:
   ...
   1. (Alleen aangepaste segmenten; optioneel) Bewerk de **[!UICONTROL Segment Window]** . Dit is het aantal dagen dat de cookie van een gebruiker in het segment blijft staan.
