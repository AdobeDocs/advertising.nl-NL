...
Adobe werkt samen met elke adverteerder om zijn advertentienetwerkrekeningen en campagnes op te zetten. Dit omvat het configureren van Zoeken, Sociaal, &amp; Commerce voor verbinding en synchronisatie met de accounts van de adverteerder, het maken van nieuwe campagnes en campagnecomponenten, het instellen van tracering voor componentadvertenties, het optioneel toevoegen van campagnes aan portfolio&#39;s om Zoeken, Sociaal en Commerce in staat te stellen om het bod op advertenties te optimaliseren en het valideren van de initiële kosten, klikken en inkomstengegevens.

Nadat een campagne is geactiveerd en optioneel aan een portfolio is toegevoegd, moeten het Adobe-accountbeheerteam, het agententeam of de adverteerder (afhankelijk van de voorwaarden van de service level agreement) elke campagne volgen en de relevante componenten en instellingen zo nodig wijzigen om de doelstellingen van de adverteerder te halen.
...
1. De volgende instellingen instellen voor alle advertenties waarvoor Adobe Advertising conversies bijhoudt:

   1. (Advertisers met de de conversie volgende dienst van Adobe Advertising) indien nodig, [&#x200B; opstelling klikt het volgen &#x200B;](/help/search-social-commerce/tracking/click-tracking-ways-to-generate.md) voor advertenties, en naar keuze voor sleutelwoorden, plaatsen, en voegt uitbreidingen toe door Onderzoek, Sociale, &amp; klik-volgende URLs van Commerce te produceren en te uploaden.
