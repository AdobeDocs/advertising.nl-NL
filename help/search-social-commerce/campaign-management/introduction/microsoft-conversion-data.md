...
Met Zoeken, Sociaal en Handel worden automatisch alle conversies gesynchroniseerd die door uw [[!DNL Microsoft® Advertising] UET-tags (Universal Event Tracking)](https://about.ads.microsoft.com/solutions/tools/universal-event-tracking) voor websiteconversies, met inbegrip van doorkijkconversies, voor rapportage en optimalisatie.
