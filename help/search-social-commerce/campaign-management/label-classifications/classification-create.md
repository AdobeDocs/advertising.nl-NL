...
## (Nieuwe interface) Een labelclassificatie maken

1. Klik op **[!UICONTROL Reports]>[!UICONTROL Label Classifications]** .

1. Klik in de rechterbovenhoek op **[!UICONTROL Create Classification]** .

1. Voer een unieke labelclassificatienaam in en klik op **[!UICONTROL Create]** .
...
## (Verouderde gebruikersinterface) Een labelclassificatie maken
