...
| [!UICONTROL Ad Group Type] | <p>Het type advertentiegroep: <i>[!UICONTROL Discovery]</i> (alleen voor detectiecampagnes), <i>[!UICONTROL Display]</i> (voor weergavecampagnes), <i>[!UICONTROL Search Dynamic]</i> (voor uitgevouwen dynamische zoekadvertenties), <i>[!UICONTROL Search Standard]</i> (voor zoekadvertenties), <i>[!UICONTROL Shopping Product]</i> (voor winkelproductadvertenties), <i>[!UICONTROL Shopping Showcase]</i> (maken en bewerken niet ondersteund) of <i>[!UICONTROL Unknown]</i> .</p> |
