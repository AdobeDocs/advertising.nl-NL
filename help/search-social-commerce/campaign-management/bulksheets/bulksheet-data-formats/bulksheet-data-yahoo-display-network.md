---
title: Bulksheet gegevens voor  [!DNL Yahoo! Display Network]  rekeningen
description: Verwijzing de kopbalgebieden en gegevensgebieden in gedownloade bulksbladen voor  [!DNL Yahoo! Display Network]  rekeningen.
...
# Bijlage - Werkbladgegevens voor [!DNL Yahoo! Display Network] -accounts
...
U kunt gegevens voor [!DNL Yahoo! Display Network] -accounts bulksgewijs downloaden, maar u kunt geen bulksbladen uploaden of posten naar het advertentienetwerk.
...
| [!UICONTROL Destination URL] | nvt | nvt | nvt | (Opgenomen in gegenereerde bulksbladen voor informatiedoeleinden; niet gepost naar het advertentienetwerk) Voor accounts met doel-URL&#39;s is deze waarde de URL die een advertentie koppelt aan een basis-URL/bestemmingspagina op de website van de adverteerder (soms via een andere site die de klik bijhoudt en de gebruiker vervolgens doorstuurt naar de bestemmingspagina). Het bevat alle toevoegingsparameters die zijn geconfigureerd voor de campagne of account voor Zoeken, Sociaal zoeken en Commerce. Als u URL&#39;s voor bijhouden hebt gegenereerd, is deze waarde gebaseerd op de volgende parameters in uw accountinstellingen en campagnemontages. Als u netwerkspecifieke parameters hebt toegevoegd, kunnen deze worden vervangen door de equivalente parameters voor Zoeken, Sociaal en Commerce. |
...
| [!UICONTROL AMO ID] | nvt | nvt | nvt | (In gegenereerde bulksbladen) Een door Adobe gegenereerde unieke id voor een gesynchroniseerde entiteit. |
| [!UICONTROL EF Error Message] | nvt | nvt | nvt | (Opgenomen in gegenereerde bulksbladen ter informatie) Tijdelijke aanduiding voor het weergeven van foutberichten van Zoeken, Sociaal en Commerce over gegevens in de rij; foutberichten worden opgenomen in [!UICONTROL EF Errors] -bestanden. |
