...
**[!UICONTROL Google Recommended Budget]:** (Optioneel; van toepassing op maximale prestaties en zoekcampagnes met alle vereiste instellingen en alleen voor advertentiegroepen) Klik op **[!UICONTROL Show Recommendation]** om het budget weer te geven dat [!DNL Google Ads] aanbeveelt. Momenteel komen alleen campagnes met minder dan 40.000 trefwoorden in aanmerking.
