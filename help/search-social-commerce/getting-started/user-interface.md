...
* **[!UICONTROL Goals]** submenu:
   ...
   * **[!UICONTROL Conversion Value Rules]** Hiermee opent u alleen-lezenweergaven van uw regels voor conversiewaarden op campagnereniveau en op accountniveau. Als u de regels voor de conversiewaarde wilt beheren, gebruikt u de oude weergave [!UICONTROL Optimization] > [!UICONTROL Conversion Value Rules] .
