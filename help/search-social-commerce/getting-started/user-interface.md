...
* **[!UICONTROL Manage]** submenu:
   ...
   * **[!UICONTROL Portfolio Groups]:** Sluit de nieuwe UI-site af en opent de verouderde [!UICONTROL Search, Social, & Commerce] > [!UICONTROL Optimization] > [!UICONTROL Portfolios] weergave > [!UICONTROL Portfolio Groups] tab.
