...
* Vanuit een [!UICONTROL Notification Center] -webtoepassing, die [!UICONTROL Notification Center] opent in een apart venster buiten Zoeken, Sociaal en Commerce.
...
* **[!UICONTROL Recommendations]**: mogelijkheden die zijn geïdentificeerd om de prestaties te verbeteren, best practices te implementeren, enzovoort.

* **[!UICONTROL Warnings]**: problemen die aandacht vereisen, maar die niet essentieel zijn voor optimalisatie of beheer.

* **[!UICONTROL Issues]**: kritieke problemen die directe aandacht vereisen. Foutmeldingen voor accountautorisatie worden opgenomen.
