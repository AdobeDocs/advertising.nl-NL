...
De standaardweergaven worden standaard weergegeven wanneer u zich aanmeldt. U kunt aanvullende aangepaste weergaven maken en deze op elk gewenst moment toepassen. U kunt desgewenst elke aangepaste weergave delen die u maakt met alle andere gebruikers die de gegevens van de adverteerder kunnen bekijken. In uw meningslijsten, wordt elke mening die een andere persoon deelt cursief, zoals &quot;*best-presterende Campagnes*.&quot; Alleen de persoon die een aangepaste weergave maakt, kan deze verwijderen.
...
1. In het linkerpaneel, klik ](/help/search-social-commerce/assets/custom-views-left-rail_icon.png " de Mening van de Douane van 0} ") om het [!UICONTROL Custom Views] menu uit te breiden.![
...
|   | Delen | (Alleen aangepaste weergaven; optioneel) Hiermee maakt u de weergave beschikbaar voor alle andere gebruikers die de gegevens van de adverteerder kunnen bekijken. Andere gebruikers kunnen niet de mening uitgeven of schrappen, maar zij kunnen een nieuwe mening van de montages tot stand brengen.In uw meningslijsten, elke mening die een andere persoon deelt is cursief, zoals &quot;_best-presterende Campagnes_.&quot; |
