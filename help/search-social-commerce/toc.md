...
+ (Beta) NIEUWE GEBRUIKERSINTERFACE {#new-ui}
   ...
   + Plan {#plan}
      + Doelstellingen {#objectives}
         ...
         + [Prestatiegegevens downloaden voor doelstellingen](/help/search-social-commerce/new-ui/goals/objectives/objective-download-performance-data.md)
      ...
      + Simulaties {#simulations}
         ...
         + [Gegevens over simulatie weergeven](/help/search-social-commerce/new-ui/plan/simulations/simulation-view.md)
   ...
   + Beheren {#manage}
      + Portfolio&#39;s {#portfolios}
         ...
         + [Portefeuillegroepen beheren](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-group-manage.md)
         ...
         + [Een prestatiegrafiek weergeven in de [!UICONTROL Portfolios] -weergave](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-view-performance-graph.md)
   ...
   + Instellen {#setup}
      + Accounts {#accounts}
         ...
         + API-verbindingsaccounts {#api}
            + [Netwerkaccounts beheren via API-verbinding](/help/search-social-commerce/new-ui/set-up/accounts/api-accounts/api-account-manage.md)
            + [Netwerkgegevens handmatig synchroniseren via API-verbinding](/help/search-social-commerce/new-ui/set-up/accounts/api-accounts/sync-api-accounts.md)
         + Gegevensuploadaccounts {#data-upload}
            + [Beheer en netwerkaccounts voor het uploaden van gegevens](/help/search-social-commerce/new-ui/set-up/accounts/data-upload-accounts/data-upload-account-manage.md)
         + [Beheer  [!DNL Naver]  rekeningen slechts voor het volgen](/help/search-social-commerce/new-ui/set-up/accounts/template-account-manage.md)
      ...
      + Rapporten beheren {#report-management}
         ...
         + Speciale rapporten {#specialty-reports}
            ...
            + Indelingen voor speciale rapporten {#specialty-report-formats}
               ...
               + [De [!UICONTROL Google AI Max Search Term Combination Report]](/help/search-social-commerce/reports/management/specialty/google-ai-max-search-term-combination-report.md)
               ...
               + [De [!UICONTROL Google Performance Max Placement Report]](/help/search-social-commerce/reports/management/specialty/google-performance-max-placement-report.md)
...
+ Gereedschappen {#tools}
   ...
   + Gereedschappen voor het maken en decoderen van trackingcodes{#tracking}
      ...
      + [Een Adobe Advertising-conversietag genereren en implementeren](/help/search-social-commerce/tools/conversion-tag-generate.md)
