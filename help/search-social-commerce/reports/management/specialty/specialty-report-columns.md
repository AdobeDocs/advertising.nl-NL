...
| [!UICONTROL Ad Group ID] | De numerieke id die door Search, Social en Commerce wordt toegewezen aan de advertentiegroep. |
...
| [!UICONTROL Ad Title] | ([!UICONTROL MSA Ad Extension] rapporten) De advertentitel. |
...
| [!UICONTROL All Cost Per Conversion] | ([!UICONTROL MSA Ad Extension] rapporten) De kosten per conversie. &lt;!— Hoe verschilt dit — en de andere velden — van standaardmeetgegevens, zoals &quot;Kosten per omzetting&quot; —> |
...
| [!UICONTROL Asset ID] | ([!UICONTROL RSA Asset Report]) De numerieke id die door Search, Social en Commerce wordt toegewezen aan het element. |
...
| [!UICONTROL Category] ([!UICONTROL 1st level] - [!UICONTROL 5th level]) | ([!UICONTROL AdWords Shopping Performance Report]) Eerste niveau tot vijfde niveau [!DNL Google] productcategorieën. |
...
| [!UICONTROL Click Match Type] | ([!UICONTROL Keyword Daily Impression Share Report]) Het trefwoordtype voor de advertentie waarop is geklikt. Deze waarde is gelijk aan het type Aanbiedingsovereenkomst, behalve voor [!DNL Microsoft Advertising] trefwoorden met meerdere overeenkomende typen. Voor [!DNL Microsoft Advertising] trefwoorden, deze waarde is het type overeenkomst waarop daadwerkelijk is geklikt. |
| [!UICONTROL Click Type] | Wat de gebruiker klikte. Waarden kunnen het volgende omvatten:<ul><li>*[!UICONTROL driving_direction]*: Klik op een koppeling voor een extensie van een locatie op een advertentie voor aanwijzingen</li><li>*[!UICONTROL other]*</li><li>*[!UICONTROL phone_calls]*: Klik op een koppeling voor een telefoonuitbreiding op een advertentie om een telefoongesprek te maken</li><li>*[!UICONTROL print_offer]*: Klik op een [!DNL Google] aanbieden in een advertentie</li><li>*[!UICONTROL product_extension]*: Klik om de informatie over productextensies uit te breiden in een advertentie</li><li>*[!UICONTROL product_listing _ads]*: Klik op een advertentie</li><li>*[!UICONTROL sitelink]*: Klik op een sitelink in een advertentie</li><li>*[!UICONTROL url_clicks]*: Klik op een advertentie die een basis-URL bevat die naar uw website leidt.</li></ul> |
...
| [!UICONTROL Keyword ID] | De numerieke id die Zoeken, Sociaal en Commerce toewijst aan het trefwoord. |
| [!UICONTROL Keyword Extension ID] | ([!UICONTROL MSA Ad Extension by Keyword Report]) De numerieke id die het advertentienetwerk toewijst aan de extensie. |
...
| [!UICONTROL Search IS% Lost to Bid (Bing)] | ([!DNL Microsoft Advertising] alleen; [!UICONTROL Campaign Daily Impression Share Report] en [!UICONTROL Keyword Daily Impression Share Report]; gegevens alleen beschikbaar tot en met 11 oktober 2019) Het geschatte percentage indrukken dat je advertentie niet heeft ontvangen omdat je bod te laag was of omdat je bod en de kwaliteitsscore onder de minimumdrempels lagen. Percentages onder 10% worden aangeduid als &quot;`<10%`en percentages van meer dan 90% worden aangeduid als &quot;`>90%`.&quot; |
...
| [!UICONTROL Search IS% Lost to Keyword Relevance (Bing)] | ([!DNL Microsoft Advertising] alleen; [!UICONTROL Campaign Daily Impression Share Report] en [!UICONTROL Keyword Daily Impression Share Report]; gegevens alleen beschikbaar tot en met 11 oktober 2019) Het geschatte percentage indrukken dat uw advertentie niet heeft ontvangen vanwege onvoldoende trefwoordrelevantie. Percentages onder 10% worden aangeduid als &quot;`<10%`en percentages van meer dan 90% worden aangeduid als &quot;`>90%`.&quot; |
| [!UICONTROL Search IS% Lost to Page Relevance (Bing)] | ([!DNL Microsoft Advertising] alleen; [!UICONTROL Campaign Daily Impression Share Report] en [!UICONTROL Keyword Daily Impression Share Report]; gegevens alleen beschikbaar tot en met 11 oktober 2019) Het geschatte percentage indrukken dat uw advertentie niet heeft ontvangen vanwege onvoldoende paginarelevantie. Percentages onder 10% worden aangeduid als &quot;`<10%`en percentages van meer dan 90% worden aangeduid als &quot;`>90%`.&quot; |
