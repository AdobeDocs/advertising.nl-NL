...
| Kolom | Beschrijving |
|----|----|
| \[Advertiser-specifieke, aangepaste (afgeleide) metriek\] | De waarde voor douanemetrisch u hebt gecreeerd die van bestaande metriek wordt berekend. |
...
| [!UICONTROL Absolute Top Impression Share Percent] | De beelden u in de absolute hoogste plaats (eerste en boven de organische onderzoeksresultaten) hebt ontvangen gedeeld door het geschatte aantal beelden die u in aanmerking kwam om op de hoogste plaats te ontvangen. |
| [!UICONTROL Account Name] | De accountnaam. |
| [!UICONTROL Account Number] | ([!UICONTROL MSA Ad Extension] reports) The account identifier assigned by the add network. |
| [!UICONTROL Account Status] | ([!UICONTROL MSA Ad Extension] reports) The account status: *[!UICONTROL Active]*, *[!UICONTROL Paused]* of *[!UICONTROL Inactive]*. |
| [!UICONTROL Ad Distribution] | ([!UICONTROL Bing Ads Geo Report] , [!UICONTROL MSA Network Impression Share Report] en [!UICONTROL MSA Network Performance Report]) Waar de advertentie is gedistribueerd: *[!UICONTROL Audience]* (op het publieksnetwerk) *,[!UICONTROL Search]* (op pagina&#39;s met zoekresultaten) of *[!UICONTROL Content]* (op websites die eigendom zijn van [!DNL Microsoft] of deelnemende partnerwebsites). |
| [!UICONTROL Ad Extension ID] | ([!UICONTROL MSA Ad Extension] rapporten) identiteitskaart voor de advertentie uitbreiding. |
| [!UICONTROL Ad Extension Number] | ([!UICONTROL MSA Ad Extension] reports) The version attribute for the add extension. |
...
| [!UICONTROL Ad Title] | ([!UICONTROL MSA Ad Extension] reports) De titel van de advertentie. |
...
| [!UICONTROL Display Name] | ([!UICONTROL Google Performance Max Placement Report]) De naam die in de plaatsing wordt weergegeven, zoals de URL van de website, de naam van de mobiele toepassing of de naam van een [!DNL YouTube] -video. |
...
| [!UICONTROL Impression Share Percent] | De beelden die je hebt ontvangen, gedeeld door het geschatte aantal indrukken dat je in aanmerking kwam. |
...
| [!UICONTROL Placement] | ([!UICONTROL Google Performance Max Placement Report]) De naam van de plaatsing. |
| [!UICONTROL Placement Type] | ([!UICONTROL Google Performance Max Placement Report]) Het type plaatsing waarin de advertentie werd aangeboden: *[!UICONTROL Mobile App]* , *[!UICONTROL YouTube Video]* (de advertentie werd weergegeven in of naast een [!DNL YouTube] video) of *[!UICONTROL Webpage]* . |
...
| [!UICONTROL Search (Top) IS] | ([!DNL Google Ads] en [!DNL Microsoft Advertising]; [!UICONTROL Campaign Daily Impression Share Report] en [!UICONTROL Keyword Daily Impression Share Report]) De indrukken die u hebt ontvangen op de bovenste locaties (boven de organische zoekresultaten) gedeeld door het geschatte aantal indrukkingen dat u in aanmerking kwam om op de bovenste locaties te ontvangen. Percentages onder 10% worden vermeld als &quot;`<10%`&quot; of &quot;`0.0999`&quot;. |
...
| [!UICONTROL Search impr. share] | ([!DNL Google Ads] slechts; [!UICONTROL Campaign Daily Impression Share Report] en [!UICONTROL Keyword Daily Impression Share Report]) de beelden u hebt gedeeld door het geschatte aantal beelden die u verkreeg te ontvangen. De percentages onder 10% worden vermeld als &quot;`<10%`,&quot;en de percentages boven 90% worden vermeld als &quot;`>90%`&quot;. |
...
| [!UICONTROL Target URL] | ([!UICONTROL Google Performance Max Placement Report]) De URL voor de plaatsing, zoals een website, of een koppeling naar een mobiele app in een App Store, of URL voor een [!DNL YouTube] -video. |
...
| [!UICONTROL Top Impression Share Percent] | De indrukken die u hebt ontvangen op de mainline (de bovenste foto en de plaatsingen boven de zoekresultaten) gedeeld door het geschatte aantal indrukken dat u in aanmerking kwam voor opname op de bovenste locatie. |
