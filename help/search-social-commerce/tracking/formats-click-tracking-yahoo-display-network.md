...
description: Leer over de klik-volgende formaten voor  [!DNL Yahoo! Display Network]  rekeningen.
...
# Opmaak voor het bijhouden van klikken op gesponsorde advertenties op [!DNL Yahoo! Display Network]
