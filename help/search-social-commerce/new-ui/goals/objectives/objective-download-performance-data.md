---
title: (Nieuwe interface) Download prestatiegegevens voor doelstellingen
description: Leer hoe u doelstellingen downloadt in een spreadsheetbestand.
...
# (Nieuwe interface) Download prestatiegegevens voor doelstellingen

*eigenschap van Beta*

<!-- EDIT ALL -->

U kunt het aantal bijbehorende portefeuilles downloaden, waarde klikken, kosten per indruk (CPC), en beelden voor veelvoudige doelstellingen tegelijkertijd aan een dossier in [!DNL Microsoft Excel] werkboek (XLSX- dossier) formaat klikken.

## Een rapport genereren met de gefilterde gegevensrijen

1. Klik in het hoofdmenu op **[!UICONTROL Goals]>[!UICONTROL Objectives]** .

1. Geef de doelstellingen op waarvan u de gegevens wilt downloaden:

   * Als u gegevens voor specifieke doelstellingen wilt downloaden, schakelt u de selectievakjes naast de doelstellingen in.
...
1. Voer in de instellingen van [!UICONTROL Grid Reports] een unieke rapportnaam in en klik op **[!UICONTROL Generate]** .
   ...
   Standaard krijgt het bestand de naam &quot;objectief_YYYMMDD_NNN&quot;, waarbij &quot;NNNN&quot; het sequentiële taaknummer is (bijvoorbeeld &quot;target_20250402_1326).
