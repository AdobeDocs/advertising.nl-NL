...
* Alle rapporten downloaden:
   ...
   1. Schakel het selectievakje in naast elk prestatierapport en type portfoliocomponent dat u wilt opnemen.
      ...
      Voor sommige prestatierapporten kunt u kiezen of u de gegevens als diagram of als tabel wilt downloaden.

   1. Klik op **[!UICONTROL Download report]**.

* Een [!DNL model accuracy] -rapport met specifieke gegevenstypen downloaden:

   1. Klik op **[!UICONTROL Download report]** op de werkbalk voor het rapport.

   1. Schakel het selectievakje in naast elk type gegevens dat u wilt opnemen en hoe u de gegevens wilt opsplitsen (op biedeenheid en/of op volume klikken).
