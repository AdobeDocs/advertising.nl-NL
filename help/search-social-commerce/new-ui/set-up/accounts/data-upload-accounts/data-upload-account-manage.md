...
1. Specificeer de [&#x200B; rekeningsmontages &#x200B;](#account-settings):
   ...
   1. (Adverteerders met een [[!DNL Adobe Analytics for Advertising] integratie] (/help/integrations/analytics/overview.md)) Klik op het tabblad **[!UICONTROL Set up Adobe Analytics]** en bewerk de [!DNL Analytics] -rapporteringssuites die u wilt gebruiken voor het bijhouden en rapporteren van campagneactiviteiten.
