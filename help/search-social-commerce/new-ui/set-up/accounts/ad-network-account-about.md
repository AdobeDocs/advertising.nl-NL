---
title: (Nieuwe interface) Informatie over netwerkaccounts
description: Meer informatie over netwerkaccounts vindt u in de nieuwe interface Zoeken, Sociaal en Commerce.
...
# (Nieuwe interface) Informatie over netwerkaccounts
...
Zie het hoofdstuk over Campagnebeheer voor meer informatie over het maken en bewerken van gesynchroniseerde campagnes.

## Accounts waarvoor u handmatig gegevens uploadt

Voor online advertentienetwerken waarvoor Search, Social &amp; Commerce geen API-ondersteuning biedt, kunt u inhoud van de campagne en offline kosten uploaden, klikken en conversiegegevens voor een account voor rapportage en prestatiesimulaties. Zoeken, sociale media en Commerce synchroniseren geen gegevens met het advertentienetwerk, bieden geautomatiseerde biedingen en bieden geen optimalisatietypen, maar bieden u wel de mogelijkheid om kanaaloverschrijdende inzichten te stroomlijnen en mogelijkheden voor handmatige optimalisatie te identificeren.

## Op een sjabloon gebaseerde alleen-trackingaccounts

*Beschikbaar voor bestaande [!DNL Naver] slechts rekeningen*
