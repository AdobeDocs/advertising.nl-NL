...
De grafiekmening toont de verwachte objectieve waarde of andere gespecificeerde metrische ([!UICONTROL Y-Axis Metric]<!-- I see Objective Value, Cost, Clicks, the metrics in the portfolio's objective, and then a couple of other conversion metrics. Where do the other conversion metrics come from? -->) voor het uitgavendoel voor elk van 20 uitgavenniveaus. Het doel middelpunt wordt geïdentificeerd, en u kunt naar keuze veranderen het doel middelpunt om de voorspelde gegevens te zien gebruikend die waarde. Plaats de cursor op een willekeurig punt in de grafiek om de gegevens voor dat punt weer te geven.

U kunt de gegevens met en zonder toegepaste beperkingen, met toegepaste beperkingen en zonder toegepaste beperkingen bekijken. Wanneer u gegevens bekijkt die rekening houden met beperkingen, worden de toegepaste beperkingen boven de grafiek weergegeven.

##### Tabelweergave

In de tabelweergave ziet u de doeluitgaven voor elk van de 20 uitgavenniveaus. Het omvat ook de overeenkomstige geschatte kosten, de marginale kosten tot de objectieve waarde, kliks, de objectieve waarde en de conversiemetriek in de doelstelling van de portefeuille voor elk bestedingsniveau. Het doel middelpunt wordt geïdentificeerd, en u kunt naar keuze veranderen het doel middelpunt om de voorspelde gegevens te zien gebruikend die waarde.

U kunt de gegevens met en zonder toegepaste beperkingen, met toegepaste beperkingen en zonder toegepaste beperkingen bekijken. Wanneer u gegevens bekijkt die rekening houden met beperkingen, worden de toegepaste beperkingen boven de grafiek weergegeven.

##### Simulatie-instellingen

De simulatie-instellingen worden weergegeven als alleen-lezen onder de grafiek of tabel.

##### Portfolio-instellingen

Klik op **[!UICONTROL Portfolio Settings]** in de rechterbovenhoek om de alleen-lezen instellingen voor het desbetreffende portfolio te zien.
...
De grafiekmening toont de verwachte objectieve waarde of andere gespecificeerde metrische ([!UICONTROL Y-Axis Metric]<!-- I see Objective Value, Cost, Clicks, the metrics in the portfolio's objective, and then a couple of other conversion metrics. Where do the other conversion metrics come from? -->) voor het uitgavendoel voor het gespecificeerde aantal uitgavenniveaus (stappen) voor de simulatie. Het middelpunt van het doel wordt geïdentificeerd. Plaats de cursor op een willekeurig punt in de grafiek om de gegevens voor dat punt weer te geven.

Wanneer de simulatie werd gebouwd met inachtneming van beperkingen, worden de toegepaste beperkingen boven de grafiek geïdentificeerd.

##### Tabelweergave

De lijstmening toont het doel uitgeeft voor elk van het gespecificeerde aantal uitgavenniveaus (stappen) voor de simulatie. Het toont ook de overeenkomstige geschatte kosten, de marginale kosten aan objectieve waarde, kliks, objectieve waarde, en omzettingscijfers in de doelstelling van de portefeuille voor elk bestedingsniveau. Het middelpunt van het doel wordt geïdentificeerd.
