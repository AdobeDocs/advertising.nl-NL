...
1. Voer een van de volgende handelingen uit:
   ...
   * (Uiteindelijke knooppunten zonder originelen) Klik onder het knooppunt op **[!UICONTROL Assign Bundles]** .

   * (Knooppunten met bestaande creatieven) Houd de cursor boven het creatieve bundelvak onder het doelknooppunt en klik op **[!UICONTROL ...]** > **[!UICONTROL Edit Bundles]** .
