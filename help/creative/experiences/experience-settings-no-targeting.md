...
**[!UICONTROL Ad Type]:** (Alleen-lezen voor bestaande ervaringen) Het type advertenties dat in de ervaring is opgenomen: *[!UICONTROL Standard Display]*, *[!UICONTROL Dynamic Display]*, *[!UICONTROL Standard Video]* of *[!UICONTROL Display Video]* . Nadat u de ervaring hebt opgeslagen, kunt u het advertentietype niet meer wijzigen.
