...
1. Terwijl u [ creeert ](experience-create-targeting.md) of [ het uitgeven ](experience-edit-targeting.md) de ervaring, open de creatieve optimaliseringsmontages:

   1. Houd de cursor boven het creatieve bladknooppunt onder het doelknooppunt en voer de volgende handelingen uit:

      * Klik voor bestaande bundels op **[!UICONTROL ...]** > **[!UICONTROL Edit Bundles]** .

      * Voor nieuwe bundels, klik **[!UICONTROL ...]** > **[!UICONTROL Assign Bundles]** en [ wijs de bundels ](experience-assign-creative-bundles.md) toe.

1. Klik op de tab **[!UICONTROL Creative Optimization]** .
...
1. Voor het eerste schema:
   ...
   1. Selecteer het type creatieve rotatie:
      ...
      * *[!UICONTROL Weighted]:* roteert de creatieve elementen in elke bundel manueel volgens relatieve gewichten. Voer het gewicht van elke bundel in als een percentage. Om gelijke gewichten op alle bundels in het programma toe te passen, klik (![ pas gelijk gewicht ](/help/creative/assets/apply-equal-weight.png " toe is gelijk gewicht ")). De gewichten voor alle geselecteerde bundels moeten optellen tot 100.
