...
description: Leer hoe u groepen van creatieve personen beheert en gebruikt.
...
Bundels zijn groepen creatieve elementen die u als eenheid aan een ervaring kunt toevoegen. Nadat u een bundelcontainer hebt gemaakt, kunt u creatieve elementen aan de bundel koppelen. Standaardweergavebundels kunnen alleen standaard-weergaveadvertenties bevatten, standaardvideopakketten kunnen alleen standaard-videobanden bevatten, dynamische weergavebundels kunnen alleen dynamische weergaveadvertenties bevatten en dynamische videobundels kunnen alleen dynamische videopaden bevatten. U kunt de landingspagina&#39;s, de beeld-volgtags, en klik-volgmarkeringen voor alle creatieve binnen een bundel met voeten treden die aan een ervaring van binnen de ervaring beslissingsboom wordt toegewezen, zonder de basiscreatieven te beïnvloeden.

[!DNL Creative] roteert door de creatieve elementen in de bundel zoals gespecificeerd voor elke ervaring waaraan de bundel wordt toegewezen. U kunt desgewenst toestaan dat [!DNL Creative] de advertentie-elementen optimaliseert voor elke ervaring op basis van prestaties met behulp van algoritme en rotatie, die wordt aangedreven door [!DNL Adobe AI] .
...
1. Ga een unieke **[!UICONTROL Bundle Name]** en **[!UICONTROL Bundle Type]in:** *StandaardVertoning* (voor standaardvertoningscreatieve producten), *Dynamische Vertoning* (voor dynamische vertoningscreatieven), *StandaardVideo* (voor standaard videocreatieve producten), of *Dynamic Video* (voor dynamische videocreatieven).

1. Klik op **[!UICONTROL Create]**.

## De creatieve elementen in een bundel weergeven
...
1. Klik op de bundelkaart of rij om alle creatievelingen in de bundel te bekijken.
...
1. Selecteer de bundels die u wilt dupliceren:
   ...
   * Als u een of meer bundels wilt dupliceren, schakelt u het selectievakje in voor elke bundel die u wilt dupliceren. Klik op de werkbalk voor bulkacties op **[!UICONTROL Duplicate].**
   ...
   De nieuwe bundels krijgen de naam `<original name> (copy) # 1` (of het volgende nummer in de reeks). Als u bijvoorbeeld twee duplicaten van &quot;Testbundel&quot; maakt, krijgen de duplicaten de naam &quot;Testbundel (kopie) # 1&quot; en &quot;Testbundel (kopie) # 2&quot;.

## Een bundelnaam bewerken

Wijzigingen in een bundelnaam worden verspreid over alle bijbehorende ervaringen.
...
U kunt bestaande standaardweergavefuncties aan een standaardweergavebundel, standaard videocreatives aan standaardvideobundels, dynamische weergavefuncties aan een dynamische bundel en dynamische videocreatives aan een videobundel koppelen. Als u een creative aan een bundel koppelt, maakt u de creatieve inhoud beschikbaar in alle ervaringen waaraan de bundel is toegewezen. Elke bundel kan slechts één van elke \[creatieve grootte of duur + taal\]-combinatie bevatten.
...
1. (Facultatief) schakelaar tussen de standaardlijstmening en een kaartmening van de beschikbare bundels door ![&#x200B; de mening van de Kaart van 0&rbrace; te klikken &#x200B;](/help/creative/assets/card-view-button.png " om de kaartmening te openen of ") om aan de lijstmening terug te keren.![Tabel-/lijstweergave](/help/creative/assets/table-view-button.png "Table view")
...
1. Selecteer de creatieve elementen die u van de bundel wilt loskoppelen:
   ...
   * Een enkele creatieve bewerking loskoppelen:
      ...
      * Houd de cursor in de tabelweergave boven de rij en klik op **[!UICONTROL Detach]** .

   * Als u een of meer creatievelingen wilt loskoppelen, schakelt u het selectievakje in voor elk creatief dat u wilt loskoppelen. Klik op de werkbalk voor bulkacties op **[!UICONTROL Detach]** .

     Als u alle rijen wilt selecteren, schakelt u het globale selectievakje linksboven in.

## Een voorvertoning van één creative weergeven in een bundel

U kunt een voorvertoning van een creative weergeven zoals gebruikers deze zien, inclusief hyperlinks.
...
1. Selecteer de bundel:
   ...
   * Houd de cursor in de tabelweergave boven de rij en klik op **[!UICONTROL Preview]** .

1. (Optioneel) Als u de creatievelingen op taal wilt filteren, selecteert u een optie in de lijst **[!UICONTROL Language]** en klikt u vervolgens op **[!UICONTROL Preview]** rechtsboven in de voorvertoning.

1. (Optioneel) Als u de creatievelingen op grootte wilt filteren, selecteert u een optie in de lijst **[!UICONTROL Size]** en klikt u vervolgens op **[!UICONTROL Preview]** rechtsboven in de voorvertoning.

1. (Optioneel) Als u de grootte van de afbeeldingen in het scherm wilt wijzigen, selecteert u een optie in de lijst van **[!UICONTROL Zoom]** van 10% tot 100% van de afbeeldingsgrootte.
...
## Het wijzigingslogboek voor een bundel weergeven
...
1. Selecteer de bundel:
   ...
   * Klik in de kaartweergave op **[!UICONTROL ...]** naast de bundelnaam en klik vervolgens op **[!UICONTROL Change Log]** .

   * Houd in de tabelweergave de cursor boven de rij en klik op **[!UICONTROL More]** > **[!UICONTROL Change Log]** .

1. (Optioneel) Wijzig het gerapporteerde tijdbereik.

1. (Optioneel) Als u een notitie wilt toevoegen, houdt u de cursor boven de rij en klikt u op **[!UICONTROL Add Notes]** . Voer de notitie in en klik op **[!UICONTROL Save]** .

1. (Optioneel) Als u de vermelding in het wijzigingslogboek, inclusief toegevoegde notities, wilt weergeven, houdt u de cursor boven de rij en klikt u op **[!UICONTROL View Details]** .
