...
description: Leer hoe u de creatieve producten beheert die u in uw advertentiebeleving gebruikt.
...
* **Individuele creatieven:** u kunt individuele creatieve personen direct binnen en ervaringen omvatten die geen bepaalde gebruikersdoelstellingen hebben. U kunt uw creatieven ook gebruiken om bundels tot stand te brengen, die u in gerichte [ en ervaringen ](/help/creative/experiences/experience-about.md) kunt omvatten.
   ...
   * **Standaard creatieven:** u kunt creatieve elementen in [ diverse formaten ](#creative-creative-formats) uploaden en beheren. Voor elke creatieve advertentie geeft u de standaardtaal op voor elke advertentie waarmee u de creatieve, standaardopeningspagina koppelt die wordt geopend wanneer een gebruiker op een advertentie klikt die de creatieve, en optionele labels bevat die als filters binnen verschillende weergaven binnen [!DNL Creative] worden gebruikt.

   * **Dynamische creatieven:** (De Bestaande klanten van DCO van de Adobe Advertising slechts) de gebruikers van de Beheerder kunnen dynamisch-geproduceerde creatieven tot stand brengen door dynamische variabelen in een advertentiemalplaatje aan waarden in een voederdossier in kaart te brengen. Alle gebruikers kunnen bestaande dynamische advertenties voorvertonen, dupliceren en verwijderen.
...
## Ondersteunde creatieve indelingen {#creative-creative-formats}
...
>[!IMPORTANT]
>
>Zelfs als u HTMl5, Flexible HTML5 of creatieve projecten van derden wilt gebruiken voor uw advertentieervaring, moet u ook creatieve afbeeldingen toevoegen voor elke creatieve grootte die u wilt gebruiken.
>
...
Flexibele HTML5-creatieven zijn HTML5-creatieven met al hun afbeeldingen en andere kenmerken als standaard-HTML-tags, die u rechtstreeks in [!DNL Creative] kunt bewerken, in een creatieve bibliotheek of binnen een individuele ervaring (waardoor een variant van de oorspronkelijke creatieve elementen ontstaat). De flexibele creatieve HTML5 gebruiken de norm van het Laboratorium van de Technologie van het Bureau van Interactive Advertising (IAB) voor een [ ad portefeuille ](https://flexibleads.iabtechlab.com/), waarvoor ad formaatgrootte (eerder dan vast) flexibel is en op de het aspectverhouding en de groottewaaier van het bureau gebaseerd is, en waarvoor de advertenties hun resolutie over apparaten en uitgeversplaatsen handhaven.
...
U kunt desgewenst de standaardwaarden wijzigen van de kenmerken die zijn opgegeven in een flexibele HTML5-functie. Later kunt u aangepaste waarden opgeven voor de kenmerken binnen een bepaalde ervaring. Hierdoor wordt een variatie van de bovenliggende creatieve elementen gemaakt.

#### HTML5 creatieve producten

U kunt eenvoudige of statische HTML5-creatieven uploaden, waarbij alle kenmerken en afbeeldingen zijn opgegeven als ZIP-bestanden. U kunt geen kenmerken bewerken of afbeeldingen toevoegen. U kunt in plaats daarvan een nieuw ZIP-bestand uploaden om een nieuwe creatieve functie toe te voegen. Zie de [ specificaties voor eenvoudige en statische HTML5 creatieve ](html5-creative-specification.md).

#### Afbeeldingscreatieven

U kunt creatieve afbeeldingen opnemen in GIF-, JPEG-, JPG- of PNG-indeling. U kunt <!--LATER:   images from your Adobe Experience Manager accounts or --> -afbeeldingen uploaden vanaf uw apparaat of netwerk.
...
Beheerders kunnen dynamisch gegenereerde creatieve elementen maken in de statische HTML5- en dynamische HTML5-indeling door dynamische variabelen in een advertentiesjabloon toe te wijzen aan waarden in een feed-bestand. Dit kunnen creatieve producten uit uw oudere Adobe Advertising Dynamic Creative Optimization (DCO)-ervaringen omvatten.
...
De mogelijkheid om dynamische creatieve documenten te maken en te bewerken is momenteel alleen beschikbaar voor het accountteam van de Adobe. Alle gebruikers kunnen echter:
