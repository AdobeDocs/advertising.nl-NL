...
* **Creatieve bundels:** Groepeer creatieve elementen in bundels over veelvoudige ervaringen met bepaalde gebruikersdoelstellingen te gebruiken. U kunt *standaardvertoningsbundels* tot stand brengen die uit standaardvertoningsadvertenties bestaan, *standaardvideobundels* die uit standaard videoadvertenties bestaan, *dynamische vertoningsbundels* die uit dynamisch geproduceerde vertoningsadvertenties, en *dynamische videobundels* bestaan die uit dynamisch geproduceerde videoadvertenties bestaan.
...
#### Standaard beeldschermcreaties

Standaardweergaveadvertenties zijn:

* HTML5-creatieven die lokaal of vanuit Adobe GenStudio for Performance Marketing zijn geüpload.
* Afbeeldingsbestanden die lokaal of vanuit Adobe Experience Manager zijn geüpload.
...
* **ervaringen van GenStudio:** u kunt alle ad varianten van a [ vertoning en ervaring ](https://experienceleague.adobe.com/en/docs/genstudio-for-performance-marketing/user-guide/create/display-ad-experiences) in [ GenStudio for Performance Marketing ](https://experienceleague.adobe.com/en/docs/genstudio-for-performance-marketing/user-guide/home) als individuele HTML5 creatieve personen invoeren. Externe koppelingen worden omgezet in lokale verwijzingen. De HTML-inhoud kan maximaal 20 MB zijn en afzonderlijke afbeeldingen kunnen maximaal 50 MB groot zijn.
  ...
  >[!NOTE]
  >
  >Als u deze functie wilt gebruiken, moeten zowel de GenStudio-account als de Advertising Creative-account dezelfde organisatie-id gebruiken en moet de gebruiker rechten hebben om toegang te krijgen tot GenStudio.

* **Geüploade dossiers:** u kunt eenvoudige of statische HTML5 creatieve producten, met alle gespecificeerde attributen en beelden, als dossiers van het PIT ook uploaden. U kunt geen kenmerken bewerken of afbeeldingen toevoegen. U kunt in plaats daarvan een nieuw ZIP-bestand uploaden om een nieuwe creatieve functie toe te voegen. Zie de [ specificaties voor eenvoudige en statische HTML5 creatieven ](html5-creative-specification.md).
...
U kunt weergave- of videocamera&#39;s dynamisch genereren door dynamische variabelen in een advertentiesjabloon toe te wijzen aan waarden in een feed-bestand. Dynamische creatieve producten kunnen creatieve producten bevatten die zijn gemigreerd uit uw oudere Adobe Advertising Dynamic Creative Optimization (DCO)-ervaringen.

#### Dynamische weergave-creatieven

Dynamische weergavefuncties hebben de HTML5-indeling en kunnen worden gebruikt in GIF-, JPG-, JPEG- of PNG-indeling.

#### Dynamische videocamera&#39;s

Dynamische videocamera&#39;s bevatten videobestanden met dezelfde specificaties als standaardvideoclips. Zie &quot;[ Video creatieve ](#creative-video-specs).&quot;

Tot de ondersteunde advertentievormen behoren startkaart, eindkaart, overlay bovenaan, bedekking onderaan of L-Vormd.
...
>* [ voeg standaardcreatieve elementen aan een bibliotheek ](creative-add-standard.md) toe
